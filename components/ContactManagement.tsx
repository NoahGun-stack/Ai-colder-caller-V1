...
interface ContactManagementProps {
    ...
    onStartCall: (contact: Contact, campaign: 'residential' | 'b2b' | 'staffing' | 'painting' | 'real_estate') => void;
    onStartPowerDial?: (contacts: Contact[], autoPilot?: boolean, batchMode?: boolean, concurrency?: number, campaign?: 'residential' | 'b2b' | 'staffing' | 'painting' | 'real_estate') => void;
    activeCampaign?: 'residential' | 'b2b' | 'staffing' | 'painting' | 'real_estate';
}
...
const ContactManagement: React.FC<ContactManagementProps> = ({ contacts, setContacts, onStartCall, onStartPowerDial, activeCampaign = 'residential' }) => {
    ...
    const [powerDialConfig, setPowerDialConfig] = useState<{ contacts: Contact[], limit: number, campaign: 'residential' | 'b2b' | 'staffing' | 'painting' | 'real_estate' }>({
        contacts: [],
        limit: 5,
                ...
                <div className="mt-4">
                    ...
                    <div className="grid grid-cols-1 gap-2">
                        {[
                            ...
                            { id: 'painting', label: 'Painting (Taylor - Estimate)', icon: 'fa-paint-roller' },
